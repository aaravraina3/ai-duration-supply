...
> **Superseded in part.** A dated record of that session, kept as written. Two
> results here were revised the same day: the 7-10y auction local projection was
> selected after seeing the cross-section, and the all-tenor version (+4.50,
> t 1.81) is now primary; and the AI comparison figure (p = 0.069) is from the
> earlier sample. Current numbers are in `03_FINDINGS.md`.
